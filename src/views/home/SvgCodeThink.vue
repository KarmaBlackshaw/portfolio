...
export default {
  ...
  mounted () {
    gsap
      .timeline({ repeat: -1, duration: 2, ease: 'circ.out', yoyo: true })
      .from('#box-1', { alpha: 0 }, 0)
      .to('#box-1', { alpha: 1 }, 0)
      .to('#box-1', { alpha: 0 }, 1)
      .from('#box-outlined-1', { alpha: 0 }, 0)
      .to('#box-outlined-1', { alpha: 1 }, 0)
      .to('#box-outlined-1', { alpha: 0 }, 1)

    gsap
      .timeline({ repeat: -1, duration: 3, ease: 'none' })
      .from('#box-2', { alpha: 1 }, 0)
      .to('#box-2', { alpha: 0 }, 1)
      .to('#box-2', { alpha: 1 }, 2)
      .from('#box-outlined-2', { alpha: 1 }, 0)
      .to('#box-outlined-2', { alpha: 0 }, 1)
      .to('#box-outlined-2', { alpha: 1 }, 2)

    gsap
      .timeline({ repeat: -1, duration: 3, ease: 'circ.out', yoyo: true })
      .from('#box-3', { alpha: 0 }, 0)
      .to('#box-3', { alpha: 1 }, 1)
      .to('#box-3', { alpha: 0 }, 2)
      .from('#box-outlined-3', { alpha: 0 }, 0)
      .to('#box-outlined-3', { alpha: 1 }, 1)
      .to('#box-outlined-3', { alpha: 0 }, 2)
  }
}
</script>
